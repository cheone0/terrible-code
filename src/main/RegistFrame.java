...
public class RegistFrame extends JFrame {
   ...
   public RegistFrame() {
      ...
      registBtn.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e, boolean idFix) {
          ...
          //  int resultLeng = resultID.length();
			...
			if(idDuplicate == true) {
            	...
            	JOptionPane.showConfirmDialog(contentPane, "아이디가 중복됩니다.", "회원가입 불가", JOptionPane.WARNING_MESSAGE);
            }
           ...
           // System.out.println("입력된 ID 길이 : "+ resultLeng);
            ...
            if(pw == null || pw.equals("")) {
               ...
               String resultPW = pw.trim().replaceAll(" ", ""); // trim : 공백 줄여주는것 
               if(resultPW.equals(rePw)) {
                  System.out.println("비밀번호가 일치 합니다.");
                  System.out.println("DB에 저장될 ㅖ PW" + pw);	
               }else {
            	   passwordField.setText("");
            	   rePasswordField.setText("");
